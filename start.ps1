...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a1ce9f01flw56-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert SensorAgua.cert.pem --key SensorAgua.private.key --client_id basicPubSub --topic sdk/test/python --count 0